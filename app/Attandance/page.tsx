...
export default function AttendanceDashboard() {
  return (
    <div className="min-h-screen bg-[#373b44] p-6 flex flex-col justify-center items-center text-white font-sans selection:bg-[#00ffd1]/30">
      <div className="w-full max-w-5xl space-y-6">
        ...
        <div className="bg-[#121316] rounded-3xl p-6 md:p-8 border border-white/5 shadow-xl">
            ...
            {attendanceData.map((item, index) => (
              ...
              >
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span
                    className={`text-xs font-semibold px-2.5 py-1 rounded-lg ${item.statusColor}`}
                  >
                    {item.status}
                  </span>
                </div>
          ...
          <div className="flex justify-center items-center gap-1 text-sm text-gray-400">
            <button className="w-8 h-8 rounded-lg bg-[#292a30] text-white flex items-center justify-center font-semibold">
              1
            </button>
            {[2, 3, 4].map((p) => (
              <button
